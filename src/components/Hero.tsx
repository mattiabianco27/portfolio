...
const Hero = () => {
  const roles = ["Computer Engineer", "Cybersecurity Specialist", "Web Developer"];
    ...
    <section className="min-h-screen flex flex-col justify-center items-center relative px-4 md:px-8">
      <div className="text-center space-y-8 animate-fade-up">
        ...
        <div className="text-2xl md:text-4xl font-light h-16 flex items-center justify-center">
          ...
          <span className="ml-3 font-medium text-gradient animate-text-morph">
            {displayText}
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          22-year-old Computer Engineering student at Politecnico di Torino, 
          passionate about web development, cybersecurity, and innovative technology.
        </p>
      </div>
